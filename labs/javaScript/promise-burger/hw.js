...
kitchen.readMenu().then(function(res) {console.log(res);});
...
kitchen.order("HELL'S FURY").then(function(res) {console.log(res);});
...
kitchen.order("quesadilla").then(function(res) {console.log(res);}).catch(function(rej) {console.log(rej);});
...
kitchen.addToMenu(newBurger).then(function(res) {console.log(res);}).catch(function(rej) {console.log(rej);});
...
kitchen.addToMenu(newBurger).then(function(res) {console.log(res);}).then(function(res) {console.log(kitchen.readMenu());}).catch(function(rej) {console.log(rej);});
